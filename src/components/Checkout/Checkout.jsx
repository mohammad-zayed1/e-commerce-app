...
const Checkout = () => {
    // console.log(userdata[0].price)
    // const [price, setPrice] = useState(0)

    // userdata.map((item) => item.price + price)
        ...
        <div>
            ...
            <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                <div class="px-4 pt-8">
                    ...
                    {
                        userdata.map((count, index) => {
                            return (

                                <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                                    <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src={count.img} alt="" />
                                    <div class="flex w-full flex-col px-4 py-4">
                                        <span class="font-semibold"> {count.title} </span>
                                        <span class="float-right text-gray-400"> {count.description}</span>
                                        <p class="mt-auto text-lg font-bold">{count.price} JD </p>
                                    </div>
                                </div>
                            )
                        })}
                    ...
                    <div class="">
                        ...
                        <div class="mt-6 border-t border-b py-2">
                            <div class="flex items-center justify-between">
                                ...
                                <p class="font-semibold text-gray-900">{total + 2} jd</p>
                            </div>
                            {/* <div class="flex items-center justify-between">
                        ...
                        <div class="mt-6 flex items-center justify-between">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{total + 2} JD</p>
                        </div>
                    </div>
                    <button onClick={handleMessage} class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Place Order</button>
                </div>
            </div>
